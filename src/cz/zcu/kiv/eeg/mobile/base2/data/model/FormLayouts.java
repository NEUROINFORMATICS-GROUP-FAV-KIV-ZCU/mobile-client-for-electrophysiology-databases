...
public class FormLayouts {
	...
	@DatabaseField(foreign = true, canBeNull = false, columnName = FK_ID_FORM, uniqueIndexName = "FormLayouts_Form_layout_idx")
	private Form form;

	@DatabaseField(foreign = true, canBeNull = false, columnName = FK_ID_LAYOUT, uniqueIndexName = "FormLayouts_Form_layout_idx")
